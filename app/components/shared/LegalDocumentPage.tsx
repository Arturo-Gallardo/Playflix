...
export function LegalDocumentPage({
  ...
  return (
    <div className="legal-page-scroll">
      <main className="legal-page font-control min-h-dvh bg-[#111111] text-white">
        <div className="legal-page-inner mx-auto w-full max-w-2xl px-5 py-10 sm:px-8 sm:py-14">
          <header className="legal-page-header space-y-3 border-b border-white/10 pb-8">
            <Link
              className="legal-page-back text-[11px] font-semibold uppercase tracking-[0.16em] text-white/50 transition hover:text-[#1DB954]"
              href="/"
            >
              ← Back to Playlix
            </Link>
